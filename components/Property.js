...
const FeaturedListings = () => {
  ...
  const listings = [
    {
      id: 1,
      title: "คอนโดริวิร่า ใกล้ม.ขอนแก่น",
      price: "฿4,500/เดือน",
    ...
    },
    {
      ...
      agent: {
        name: "Agent",
        avatar:
          "https://images.unsplash.com/photo-1494790108755-2616b612b0c0?w=40&h=40&fit=crop&crop=face",
        posted: "5 years ago",
      },
    },
    {
  ...
  const getFilteredListings = () => {
    ...
    if (filters.bedrooms !== "Bedrooms") {
      ...
      filteredListings = filteredListings.filter(
        (listing) => listing.bedrooms === bedroomCount
      );
    }
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-16 space-y-6">
          ...
          <h1 className="text-5xl lg:text-6xl font-light leading-tight mb-6">
            Discover
            <br />
            <span className="font-medium">Our Featured Listings</span>
          </h1>
          ...
          <p className="text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed">
            ค้นพบอสังหาริมทรัพย์คุณภาพ ที่ตอบโจทย์ทั้งการใช้ชีวิตทันสมัย
            และการลงทุนที่คุ้มค่า
          </p>
        </div>

        {/* Filter Section */}
        <div className="bg-white rounded-md shadow-xl p-6 mb-12 border border-gray-100">
          {/* Status Tabs */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 items-end">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-700"
              >
        ...
        <div className="flex justify-between items-center mb-8">
          <div className="text-gray-600">
            Showing {getVisibleListings().length} of {filteredListings.length}{" "}
            properties
          </div>
          <div className="flex gap-3">
            <button
              ...
              className="group p-3 bg-white rounded-md shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-blue-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <button
              ...
              className="group p-3 bg-gradient-to-r from-blue-500 to-blue-600 rounded-md shadow-lg hover:shadow-xl transition-all duration-300 hover:from-blue-600 hover:to-blue-700 disabled:opacity-50 disabled:cursor-not-allowed"
            >
        ...
        <div className="grid xl:grid-cols-3 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-6">
          {getVisibleListings().map((listing, index) => (
            <div
              key={listing.id}
              className="group bg-white rounded-md overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100"
            >
              {/* Image Container */}
              <div className="relative overflow-hidden h-48">
                ...
                <div className="absolute bottom-3 left-3">
                  <div className="bg-white/95 backdrop-blur-sm px-3 py-1.5 rounded-md shadow-md">
